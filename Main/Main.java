        ...
        while (run) {
            ...
            switch (screenNum) {
                ...
                case 5: {
                    ...
                    String[] inf = {"Fun Fact! Sports are good for your mental health, but at times like these, committing and working is still the overall best choice! Press enter to continue...", 
