...
public class Level3 {
    ...
    public Level3(){
        ...
        try {
            iArr[0] = ImageIO.read(new File("Images\\nitendoSwitch.png"));
            iArr[1] = ImageIO.read(new File("Images\\laptop.png"));
            iArr[2] = ImageIO.read(new File("Images\\phone.png"));
            iArr[3] = ImageIO.read(new File("Images\\basketball.png"));

            iArr[4] = ImageIO.read(new File("Images\\calculator.png"));
            iArr[5] = ImageIO.read(new File("Images\\pencil.png"));
            iArr[6] = ImageIO.read(new File("Images\\backPack.png"));
            iArr[7] = ImageIO.read(new File("Images\\binder.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
